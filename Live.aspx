<%@ page language="C#" autoeventwireup="true" inherits="Live, App_Web_1zsnm43z" %>
...
<head runat="server">
    ...
    <title>CSI District Church Maruthancode - Live</title>
...
<%--    Live--%>
    <div class="container">
        <div class="row">
            <div class="col-md-12 px-0">
                <div class="livevideo1">
                    <h2>24.05.2020<small>&nbsp;&nbsp;Family Sunday Service</small></h2>
                </div>
                <div class="livevideo2">
