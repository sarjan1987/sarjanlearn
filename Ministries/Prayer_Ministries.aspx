<%@ page language="C#" autoeventwireup="true" inherits="Prayer_Ministries, App_Web_1qjeo3gb" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Prayer Ministries</title>
...
<%--Announcements1--%>
    ...
    <%--Prayer Ministries--%>
    <div class="container pray1">
        <div class="row">
            <div class="col-md-4">
                <div class="pray2">
                <h2>Fasting Prayer</h2>
                <p>Prayer is an invocation or act that seeks to activate a rapport
                 with an object of worship through deliberate communication. In the
                  narrow sense, the term refers to an act of supplication or intercession
                   directed towards a deity (a god), or a deified ancestor. More generally,
                    prayer can also have the purpose of thanksgiving or praise, and in
                     comparative religion is closely associated with more abstract forms
                      of meditation and with charms or spells.[1]</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="pray2">
