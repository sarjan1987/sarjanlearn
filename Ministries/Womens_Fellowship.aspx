<%@ page language="C#" autoeventwireup="true" inherits="Womens_Fellowship, App_Web_1qjeo3gb" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Womens Fellowship</title>
...
<%--Announcements1--%>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ministries1">
                    <h1>About Our Church Womens Fellowship</h1>
                </div>
            </div>
        </div>
        <div class="row">
