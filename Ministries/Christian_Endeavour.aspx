<%@ page language="C#" autoeventwireup="true" inherits="Christian_Endeavour, App_Web_1qjeo3gb" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Christian Endeavour</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ministries1">
                    <h1>About Christian Endeavour</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="ministries1">
                    <h1>About Our Church Christian Endeavour</h1>
                </div>
            </div>
        </div>
        <div class="row">
