<%@ page language="C#" autoeventwireup="true" inherits="Video_Gallery, App_Web_oadaktxj" %>
...
<head runat="server">
    ...
    <title>CSI District Church Maruthancode - Video Gallery</title>
    ...
    <div class="container">
        ...
        <div class="row gal1">
            <div class="col-md-4">
                <div class="gal2">          
                    <div class="foldimg">
                        <a href="Video_Gallery/Lockdown_Services.aspx" title="Click to open Videos"><img border="0" src="../Photo_Gallery/Drama_Soul/IMG_3422.JPG" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Lockdown Services</h5>
                        <p>16 Videos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Video_Gallery/Drama_Videos.aspx" title="Click to open Videos"><img border="0" src="../Photo_Gallery/VBS_2018/IMG-20180424-WA0076.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Drama Videos</h5>
                        <p>6 Videos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Video_Gallery/Video_Songs.aspx" title="Click to open Videos"><img border="0" src="../Photo_Gallery/Heavenly_Souls/1523982968011.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Video Songs</h5>
                        <p>1 Videos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
        </div>
