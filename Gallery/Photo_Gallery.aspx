<%@ page language="C#" autoeventwireup="true" inherits="Photo_Gallery, App_Web_oadaktxj" %>
...
<head runat="server">
    ...
    <title>CSI District Church Maruthancode - Photo Gallery</title>
    ...
    <div class="container">
        ...
        <div class="row gal1">
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/Soul_Drama.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/Drama_Soul/IMG_3422.JPG" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Sunday School Anniversary - 2018</h5>
                        <p>10 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/VBS_2018.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/VBS_2018/IMG-20180424-WA0076.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>VBS - 2018</h5>
                        <p>6 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/Heavenly_Souls_Photos.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/Heavenly_Souls/1523982968011.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Heavenly Souls Photos</h5>
                        <p>6 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/Holy_Communion.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/Holy_Communion/IMG_9882_small.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Holy Communion - 2018</h5>
                        <p>10 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/Sunday_School_Rally_2017.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/Rally_2017/IMG20171105183226.jpg" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Sunday School Rally - 2017</h5>
                        <p>10 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gal2">
                    <div class="foldimg">
                        <a href="Photo_Gallery/Pastor_Sentoff.aspx" title="Click to open Images"><img border="0" src="../Photo_Gallery/Sent_Off/JAN_6471.JPG" width="100%" height="100%" /></a>
                    </div>
                    <div class="foldname">
                        <h5>Sent Off Photos</h5>
                        <p>10 Photos | Uploaded Date : 10.06.2020</p>
                    </div>
                </div>
            </div>
