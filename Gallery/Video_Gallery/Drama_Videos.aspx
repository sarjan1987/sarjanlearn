<%@ page language="C#" autoeventwireup="true" inherits="Drama_Videos, App_Web_kaaala5q" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Drama Videos</title>
...
<%--                <nav aria-label="breadcrumb">
                ...
                <ul class="pagination pagination-lg justify-content-center pag">
                    <li><a href="Lockdown_Services.aspx">Lockdown Services</a></li>
...
<%--                    <li><a href="Holy_Communion.aspx">Holy Communion</a></li>
        ...
        <div class="row imggal">
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Joseph Bible Drama<br /><small> Part - 1</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/1EoaX3IOLhc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Joseph Bible Drama<br /><small> Part - 2</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/KIhgWyxGOOA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Joseph Bible Drama<br /><small> Part - 3</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/c-CgpprWt3o" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Joseph Bible Drama<br /><small> Part - 4</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/MUdxSICiCOA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Joseph Bible Drama<br /><small> Part - 5</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/lfUan0gUO1U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>Short Film<br /><small> The Condition of Early Christian</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/IhWOh92Pbt8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
