<%@ page language="C#" autoeventwireup="true" inherits="Video_Songs, App_Web_kaaala5q" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Video Songs</title>
...
<%--                    <li><a href="Holy_Communion.aspx">Holy Communion</a></li>
        ...
        <div class="row imggal">
            ...
            <div class="col-md-4">
                <div class="dravid">
                    <div>
                        <h5>தட்டி தட்டி நிற்கிறார் <br /><small>Rally Competition - 2017</small></h5>
                    </div>
                    <div class="dravid1">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/qCv07leSLnM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
