<%@ page language="C#" autoeventwireup="true" inherits="Church_History_English, App_Web_c4s1yzhv" %>
...
<head runat="server">
    ...
    <title>CSI Maruthancode - Church History : English</title>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav mx-auto nav1">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">History</a>
                                <div class="dropdown-menu nav2" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="English.aspx">English</a>
                                    <a class="dropdown-item" href="Tamil.aspx">தமிழ்</a>
                                </div>
                            </li>
...
<%--                <div class="col-md-2 mb-3"><h6 class="font-weight-bold"><a href="English.aspx">History</a></h6></div>--%>
